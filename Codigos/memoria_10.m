...
gps1_noise_factor= 0.1*5;
gps2_noise_factor= 0.1*5;
gps3_noise_factor= 0.1*5;
gps4_noise_factor= 0.1*5;

gps_noise_factor = (gps1_noise_factor^2+gps2_noise_factor^2+gps3_noise_factor^2+gps4_noise_factor^2)/16;  % GPS noise factor standard deviation
...
% Lemniscate Path
% *************************************************************************
scale = 5;  % Scale of the lemniscate in meters
