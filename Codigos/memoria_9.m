...
disp(mean(sqrt((Qkalman(1, 1:end-1) - Q(1, 1:end-1)).^2 + (Qkalman(2, 1:end-1) - Q(2, 1:end-1)).^2))-mean(sqrt((Qestimated(1, 1:end-1) - Q(1, 1:end-1)).^2 + (Qestimated(2, 1:end-1) - Q(2, 1:end-1)).^2)));
